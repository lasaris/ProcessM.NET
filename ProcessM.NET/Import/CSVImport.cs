...
namespace ProcessM.NET.Import
{
    ...
    {
        /// <summary>
        /// Takes path to a .csv file as well as other optional parameters for ReadCsv method of Deedle library 
            ...
            string[] missingValues = null)
        {
            if (!File.Exists(path))
            {
                throw new ArgumentException("File with given filepath does not exist.");
            }
